...
#include <stdio.h>
#include <vector>
#include "metawarenn_provider_factory.h"
...
int main(int argc, char* argv[]) {
  ...
  OrtSessionOptionsAppendExecutionProvider_MetaWareNN(session_options);

  //*************************************************************************
  // create session and load model into memory
  // using squeezenet version 1.3
  // URL = https://github.com/onnx/models/blob/master/vision/classification/mobilenet/model/mobilenetv2-7.onnx
  OrtSession* session;
  const char* model_path = "/Path/to/mobilenetv2-7.onnx";
  ...
  std::vector<const char*> output_node_names = {"mobilenetv20_output_flatten0_reshape0"};//{"softmaxout_1"};
